-- CORREÇÃO DA FUNÇÃO DE REDEFINIÇÃO DE SENHA
-- Removendo a coluna 'updated_at' que não existe na tabela 'admins'.
...
BEGIN
    ...
    -- 2. Atualizar a senha (hash) - Apenas a coluna password_hash
