                                ...
                                <div className="space-y-4 sm:space-y-8">
                                    ...
                                    <div className="space-y-4 sm:space-y-6 max-w-[85%] sm:max-w-[90%] mx-auto">
                                        ...
                                        {(() => {
                                            ...
                                            if (!hasAllFields) {
                                                return (
                                                    <div className="flex items-start gap-3 p-3 sm:p-4 bg-gray-50 rounded-xl sm:rounded-3xl border border-gray-100 mt-2">
                                            ...
                                            if (validationMsg) {
                                                return (
                                                    <div className="flex items-start gap-3 p-3 sm:p-4 bg-rose-50 rounded-xl sm:rounded-3xl border border-rose-100 mt-2 animate-in fade-in slide-in-from-top-1 duration-300">
                                            ...
                                            return (
                                                <div className="flex items-start gap-3 p-3 sm:p-4 bg-emerald-50 rounded-xl sm:rounded-3xl border border-emerald-100 mt-2 animate-in fade-in slide-in-from-top-1 duration-300">
