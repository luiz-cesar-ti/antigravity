                ...
                <div className="flex-1 flex flex-col px-5 pt-8 pb-6 relative z-10">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full max-w-md mx-auto">
                        ...
                        <div>
                            ...
                            <div className="bg-slate-50 border border-slate-300 rounded-xl p-3 max-h-40 overflow-y-auto">
                ...
                <div className="w-full max-w-2xl mx-auto px-8 relative z-10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="bg-slate-50 border border-slate-300 rounded-xl p-3 max-h-48 overflow-y-auto">
