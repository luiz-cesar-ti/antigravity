                ...
                <div className="flex-1 flex flex-col px-6 pt-12 pb-6 relative z-10 text-center">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full max-w-sm mx-auto text-left">
                        ...
                        <div className="space-y-1.5">
                            <label className="text-xs font-bold text-blue-950 uppercase tracking-widest ml-1">
                                Identificação
                            </label>
                            <div className="relative">
                                ...
                                <input
                                    type="text"
                                    className="w-full bg-white border border-slate-300 rounded-xl py-4 pl-12 pr-4 text-slate-900 font-bold placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 transition-all shadow-sm"
                        ...
                        <div className="space-y-1.5">
                            <div className="flex justify-between items-center ml-1">
                                <label className="text-xs font-bold text-blue-950 uppercase tracking-widest">
                                    Senha
                                </label>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white border border-slate-300 rounded-xl py-4 pl-12 pr-12 text-slate-900 font-bold placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 transition-all shadow-sm"
                                    placeholder="••••••••"
                                    value={password}
